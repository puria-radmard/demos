"Copied over from https://github.com/yashsmehta/helmholtz-machine/blob/master/datasets/mnist.py!"
...
class MNIST:
    def __init__(self, data_path, binary=False):
